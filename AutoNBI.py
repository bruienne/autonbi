...
def main():
    ...
    usage = ('Usage: %prog --source/-s <path>\n'
             ...
             '                   [--add-ruby/-r]\n'
             '                   [--utilities-plist]\n'
             '    %prog creates a Lion, Mountain Lion, Mavericks, Yosemite or\n'
             '    El Capitan NetBoot NBI ready for use with a NetBoot server.\n\n'
             '    %prog has the following optional components to automate\n'
             '    typical admin tasks: NBI Index, NBI Type and Default NBI set.\n\n'
             ...
             '                 -f Packages -a --default --enable --index 6667 --type HTTP\n'
